...
if __name__ == '__main__':
    ...
    flags.DEFINE_integer('char_dim', 16, 'dimension of feed char embedding')
    ...
    model = Model(FLAGS.hidden_dim, FLAGS.num_layers, FLAGS.num_heads, FLAGS.linear_key_dim, 
                  FLAGS.linear_value_dim, FLAGS.ffn_dim, FLAGS.char_dim, FLAGS.enc_max_len, 
                  FLAGS.dec_max_len, FLAGS.max_char_len, FLAGS.batch_size, FLAGS.warmup_steps)
